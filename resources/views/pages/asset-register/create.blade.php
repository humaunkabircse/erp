...
<div class="row">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="{{ route('asset.register.store') }}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="asset_name" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('asset_name') }}" placeholder="Enter Name">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" name="asset_purshase_date" class="form-control form-control-sm" id="exampleInputEmail1" value="{{date('Y-m-d')}}" placeholder="Enter purshase date">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="asset_origin" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('asset_origin') }}" placeholder="Write origin here..">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="asset_price" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('asset_price') }}" placeholder="Enter Price">

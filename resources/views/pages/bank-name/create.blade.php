        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">Bank Name Create</h3>
            ...
            <!-- form start -->
            <form action="{{ route('bank.name.store') }}" method="POST">
                @csrf
                <div class="card-body" style="background-color:#F7F7F7">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="staticName" class="form-control form-control-sm" name="bank_name" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="staticShortName" class="form-control form-control-sm" name="bank_short_name" />

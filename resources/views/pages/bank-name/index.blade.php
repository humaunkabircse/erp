        ...
        @endif
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>Bank Name List</h4>
                    <a type="button" class="btn btn-primary float-end" href="{{route('bank.name.create')}}"><i class="fas fa-plus-circle"></i> Add New</a>
                ...
                <table id="myTable" class="display table-bordered table-striped text-center" style="border-color:white;font-size:12px;" width="100%">
                        ...
                        @foreach($bankNames as $item)
                            <tr>
                                ...
                                <td>
                                <a href="{{route('bank.name.edit',$item->id)}}" type="button" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                            @endforeach                
                       </tbody>

                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="item_name" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('item_name') }}" placeholder="Enter Name">
                            ...
                            <div class="form-group">
                                ...
                                @foreach(\App\Models\Category::where('is_parent','1')->get() as $cat)
                                    <option value="{{$cat->id}}">{{$cat->item_cat_name}}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="item_price" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('item_price') }}" placeholder="Enter Price">
    ...
    if(cat_id != null){
      $.ajax({
        ...
        success:function(response){
          var html_option = "<option value='' selected disabled>--Select Child Category--</option>";
          if(response.status){
            $('#child_cat_div').removeClass('d-none');
            $.each(response.data,function(id,item_cat_name){
                html_option += "<option value='"+id+"'>"+item_cat_name+"</option>";
            });
          }else{

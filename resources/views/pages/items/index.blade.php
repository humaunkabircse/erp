        ...
        @endif
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>Item List</h4>
                    <a type="button" class="btn btn-primary float-end" href="{{route('items.create')}}"><i class="fas fa-plus-circle"></i> Add Item</a>
                ...
                <table id="myTable" class="display table-bordered table-striped text-center" style="border-color:white;font-size:12px;" width="100%">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>{{\App\Models\ItemUnit::where('id',$item->item_unit)->value('unit_name')}}</td>
                                ...
                                <td>
                                <a href="{{route('items.edit',$item->id)}}" type="button" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                            @endforeach                
                       </tbody>

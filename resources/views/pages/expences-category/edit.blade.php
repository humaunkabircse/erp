...
<div class="col-lg-8 col-md-8  offset-md-2 col-12">
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="{{ route('expenses.category.update',$expencesCategory->id) }}" method="POST">
                @csrf
                <div class="card-body" style="background:#F7F7F7">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                        <label for="">Expenses Category Name</label>
                            <input type="text" class="form-control" name="expenses_cat_name" value="{{$expencesCategory->expenses_cat_name}}"/>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="form-group">
                                ...
                                {{$expencesCategory->expenses_cat_note}}
                                </textarea>

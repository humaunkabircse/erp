           ...
           <!-- <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-12">
                    ...
                    <p><strong>Address: </strong>{{$customerinfo->street}},{{$customerinfo->city}},{{$customerinfo->district}},{{$customerinfo->zip}},{{$customerinfo->country}}</p>
                ...
                <div class="col-md-12 col-12">
                    <table class="table table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <td width="20%">{{$item->item_price}}</td>
                            <td width="20%">{{$item->item_qty * $item->item_price}}</td>
            ...
            <div class="row mt-3 in_word">
                <div class="col-md-12 col-12">
                    ...
                    if( $tens < 20 ) { $tens=( $tens ? ' ' . $list1[$tens] . ' ' : '' ); } else { $tens=( int ) ( $tens / 10 ); $tens=' ' . $list2[$tens] . ' ' ; $singles=( int ) ( $num_part % 10 ); $singles=' ' . $list1[$singles] . ' ' ; } $words[]=$hundreds . $tens . $singles . ( ( $levels && ( int ) ( $num_part ) ) ? ' ' . $list3[$levels] . ' ' : '' ); } $commas=count( $words ); if( $commas> 1 )
                        ...
                        echo 'In Word (Taka) :'.number_to_word($total - $discount);
                        @endphp
                </div>
            </div>
...
<!-- <div class="col-md-10 offset-md-1 col-12">
    <div><h4 class="text-center mb-3">------------- Challan --------------</h4></div>
    <div class="row">
        <div class="col-md-2 col-12">
            <div class="navbar-brand">
                <a href="{{route('home')}}"><img src="{{asset('backend')}}/assets/images/logo.png" alt="" width="120px" height="50px"></a>
    ...
    <div class="row mt-5 pt-3">
        <div class="col-md-3 col-12 item-1" style="font-size:12px">
            <p>Received By</p>
        </div>
        <div class="col-md-3 col-12 item-2" style="font-size:12px">
        <p>Prepared By</p> 
        </div>
        <div class="col-md-3 col-12 item-3" style="font-size:12px">
        <p>Recommended</p>
        </div>
        <div class="col-md-3 col-12 item-4" style="font-size:12px">
        <p>Authorised Signature</p>
        </div>
    </div>
    </div> -->

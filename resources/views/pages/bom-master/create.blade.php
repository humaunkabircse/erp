        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">BOM Create</h3>
           ...
           <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm select2" name="prod_item_id" id="prod_item_id">
                                ...
                                <div class="form-group col-md-3 col-12">
                                    ...
                                    <div class="form-group col-md-3 col-12">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="used_item_unit" name="used_item_unit" readonly/>
                                    </div>
                            ...
                            <div class="card-body pt-0">
                                <form action="{{ route('bom.master.store') }}" method="POST" id="myForm">
                                    @csrf

        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>BOM List</h4>
                    <a type="button" class="btn btn-primary float-end" href="{{route('bom.master.create')}}"><i class="fas fa-plus-circle"></i> Add New</a>
                ...
                <div class="card-body" style="overflow-x:scroll">
                    <table id="myTable" class="display table-bordered table-striped text-center" style="border-color:white;font-size:12px;" width="100%">
                        ...
                        <tbody>
                            @foreach($bomMasters as $item)
                            <tr>
                                <td>{{$loop->iteration}}</td>
                                <td>{{\App\Models\Items::where('id',$item->prod_item_id)->value('item_name')}}</td>
                                <td>
                                    <a href="{{route('bom.master.edit',$item->id)}}" type="button" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>

        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">Expences Edit</h3>
                    <a href="{{ route('expenses.index') }}" class="btn btn-sm btn-primary"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Expenses list</a>
                </div>
            </div>
            <!-- /.card-header -->
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="expenses_name" value="{{$expenses->expenses_name}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="expenses_amount" value="{{$expenses->expenses_amount}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="expenses_date" value="{{$expenses->expenses_date}}"/>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="expenses_category">
                                    ...
                                    <option value="{{$item->id}}" {{$expenses->expenses_category==$item->id ? 'selected':''}}>{{$item->expenses_cat_name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cust_id">
                                    ...
                                    <option value="{{$item->id}}" {{$expenses->cust_id==$item->id ? 'selected':''}}>{{$item->cus_company}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="pay_mode">
                                    ...
                                    <option value="{{$item->id}}" {{$expenses->pay_mode==$item->id ? 'selected':''}}>{{$item->pay_mode}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="pay_tax" value="{{$expenses->pay_tax}}"/>

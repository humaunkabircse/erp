                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_name" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('vendor_name') }}" placeholder="Enter Name">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_company" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('vendor_company') }}" placeholder="Company Name">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_website" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('vendor_website') }}" placeholder="Enter website">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_contact_number" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('vendor_contact_number') }}" placeholder="Write Contact number">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_vat_number" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('vendor_vat_number') }}" placeholder="Enter Vat Number">
                            </div>
                            </div>

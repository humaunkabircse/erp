        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">Asset Deprecation</h3>
            ...
            <!-- form start -->
            <form action="{{ route('asset.deprecation.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="asset_name" name="asset_id">
                                    ...
                                    @foreach(\app\Models\AssetRegister::where('status','active')->get() as $item)
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" name="asset_deprecation_note" class="form-control form-control-sm"  placeholder="Write note hare..">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="date" name="asset_deprecation_date" class="form-control form-control-sm" id="exampleInputEmail1" value="{{date('Y-m-d')}}" placeholder="Enter purshase date">
                                @if($errors->has('asset_deprecation_date'))
                                <p class="text-danger">{{ $errors->first('asset_deprecation_date') }} </p>
                                @endif
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Asset Deprecation Value</label>
                                <input type="number" name="asset_deprecation_value" class="form-control form-control-sm" id="exampleInputEmail1" value="{{ old('asset_deprecation_value') }}" placeholder="Enter Price">

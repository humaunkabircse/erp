...
<div class="row">
    <div class="col-lg-8 col-md-8 offset-md-2 col-12">
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form action="{{ route('collection.adjustment.update',$collectionAdjustment->id) }}" method="POST">
                @csrf
                <div class="card-body" style="background-color:#F7F7F7">
                    ...
                    @endphp
                        ...
                        <div class="col-md-8">
                            <input type="text" id="staticName" class="form-control form-control-sm" name="collection_adjustment_number"  value="{{$collectionAdjustment->collection_adjustment_number}}" readonly />
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            @foreach($customers as $customer)
                                <option value="{{$customer->id}}" {{$collectionAdjustment->cus_id==$customer->id ?'selected':''}}>{{$customer->cus_company}}</option>
                            @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="date" id="staticName" class="form-control form-control-sm" name="collection_adjustment_date" value="{{$collectionAdjustment->collection_adjustment_date}}" required />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="adjustmentAmount" class="form-control form-control-sm" name="collection_adjustment_amount" value="{{$collectionAdjustment->collection_adjustment_amount}}" required />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            {{$collectionAdjustment->collection_adjustment_purpose}}
                            </textarea>
                        </div>

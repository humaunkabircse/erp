        ...
        <div class="card card-primary">
            ...
            <div class="col-12 mt-5">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm small" type="text" name="bill_number" id="bill_number" value="{{$billMaster->bill_number}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="form-group">
                                            <label>Bill Date</label>
                                            <input class="form-control form-control-sm datepicker" type="date" name="bill_date" id="bill_date" value="{{$billMaster->bill_date}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm select2" name="invoice_id" id="invoice_id" disabled>
                                                <option selected disabled>Select Invoice</option>
                                                @foreach ($invoices as $invoice)
                                                <option value="{{ $invoice->id }}" {{$billMaster->invoice_id==$invoice->id?'selected':''}}>
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('bill.master.update',$billMaster->id) }}" method="POST" id="myForm">
                        @csrf
                        <table class="table-sm table-bordered text-center" width="100%">
                            ...
                            @foreach(\App\Models\BillDetails::where('bill_id',$billMaster->id)->get() as $item)
                                <tr class="delete_item">
                                    ...
                                    <td width="15%"><input type="hidden" name="discount[]" value="{{$item->discount}}" />
                                        {{$item->discount}}
                                    </td>
                                    <td width="20%">

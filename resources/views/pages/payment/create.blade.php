                ...
                <div class="card-body" style="background-color:#F7F7F7">
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <select class="form-control" name="cus_id">
                                    <option selected disabled>--Select Customer Company--</option>
                    ...
                    <div class="row">
                        ...
                        <label for="">Check Date</label>
                            <input type="date" class="form-control form-control-sm"  value="{{date('Y-m-d')}}" name="cheque_date"/>
                    ...
                    <div class="row">
                        ...
                        <label for="">Payment Date</label>
                            <input type="date" class="form-control form-control-sm"  value="{{date('Y-m-d')}}" name="pay_date"/>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <select class="form-control" name="pay_receive_by">
                                    ...
                                    <option value="{{$agent->id}}">{{$agent->agent_fullname}}</option>
                                    @endforeach
                                </select>

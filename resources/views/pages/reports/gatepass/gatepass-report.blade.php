...
<div class="container">
  <div class="row">
    <div class="col-lg-3 col-md-3 col-12">
      <div class="">
        <h5>Search Here</h5>
        <form action="{{ route('gatepass.search') }}" method="POST">
          @csrf
    ...
    <div class="col-lg-9 col-md-9 col-12">
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          ...
          <div>
          <a href="{{route('gatePass.print',['cus_id'=>$customer_id,'start_date'=>$start_date,'end_date'=>$end_date])}}" class="btn btn-primary btn-sm btnprint">Print Preview</a>
          </div>
        ...
        <div class="card-body">
          <table id="myTable" class="display table-bordered table-striped text-center" style="border-color:white;font-size:12px;" width="100%">
            ...
            <tbody>
            @foreach($gatepassDetails as $item) 
              <tr>

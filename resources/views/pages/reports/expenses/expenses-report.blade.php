    ...
    <div class="col-lg-9 col-md-9 col-12">
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          ...
          <div>
          <a href="{{route('expenses.print',['start_date'=>$start_date,'end_date'=>$end_date])}}" class="btn btn-primary btn-sm btnprint">Print Preview</a>
          </div>
        ...
        <div class="card-body">
          <table id="myTable" class="display table-bordered table-striped text-center" style="border-color:white;font-size:12px;" width="100%">
            ...
            <tbody>
              ...
              $total=0;
              @endphp
            @foreach($expensesDetails as $item) 
              <tr>

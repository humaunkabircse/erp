...
<div class="container">
  <div class="row">
    ...
    @if(empty($paymentDetails))
      <div class="">
        <h5>Search Here</h5>
  <form action="{{ route('payment.search') }}" method="POST" class="form-inline" >
      @csrf
    ...
    <div class="col-lg-12 col-md-12 col-12">
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          ...
          <div>
          <a href="{{route('payment.print',['vendor_id'=>$vendor_id,'start_date'=>$start_date,'end_date'=>$end_date])}}" class="btn btn-primary btn-sm btnprint">Print Preview</a>
          </div>

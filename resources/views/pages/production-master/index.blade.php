        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a type="button" class="btn btn-primary float-end" href="{{route('production.master.search')}}"><i class="fas fa-plus-circle"></i> Add New</a>
                ...
                <div class="card-body" style="overflow-x:scroll">
                    <table id="myTable" class="display table-bordered table-striped text-center" style="border-color:white;font-size:12px;" width="100%">
                        ...
                        <tbody>
                            @foreach($productionMasters as $item)
                            <tr>
                                ...
                                <td>{{$item->prod_qty}}</td>
                                <td>
                                    <a href="{{route('production.master.edit',$item->id)}}" type="button" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
